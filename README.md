...
5. "Analyze ISO Results v2.r" - code to run ttests and create boxplots for isotonic data
6. "Analyze LAMSA Results v2.r" - code to run ttests and create boxplots for LaMSA data
